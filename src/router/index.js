...
const titleMaker = (...t) => t.concat('Godbreakers').join(' - ');
...
let routes = [
  {
    ...
    meta: {
      ...
      tags: [
        {
          name: 'description',
          content: 'Godbreakers - a pbta about fighting the unbroken god.',
        },
      ],
    },
  },
...
routes = routes.concat([
  {
    ...
    meta: {
      ...
      tags: [
        {
          name: 'description',
          content: 'The dice rolling and resolution mechanics in Godbreakers.',
        }
      ],
    },
  },
